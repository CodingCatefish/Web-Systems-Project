...
<head>
  ...
  <style>
    ...
    .admin-panel {
      margin-top: 1rem;
      background: linear-gradient(135deg, #f7f2e8, #fcfaf6);
    ...
    <main id="main-content" class="admin-main">
      <div class="container">
        ...
        <div class="admin-panel reveal">
          <p>
            This admin page is currently gated by PHP sessions and a secure HttpOnly session cookie.
            Administrative access should come from either a seeded SQL admin account or an explicitly configured environment admin credential.
          </p>
        </div>
      </div>
    </main>
